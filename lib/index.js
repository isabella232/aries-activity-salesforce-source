...
function avroField(field, fieldNameOverrides) {
    ...
    if (type === 'date' || type === 'datetime') {
        ...
        fieldObj.type = nillable ? ['null', avroType] : avroType;
    }

    // need to set sensible defaults to handle schema evolution (cases where new non-nil fields are added)
    if (type === 'boolean') {
        fieldObj.default = false;
    } else if (type === 'string') {
        fieldObj.default = '';
    } else if (type === 'int' || type === 'long') {
        fieldObj.default = 0;
    } else if (type === 'double') {
        fieldObj.default = 0.0;
    } else if (nillable) {
